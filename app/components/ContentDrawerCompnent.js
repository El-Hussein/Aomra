...
class Artboard3 extends Component{
    ...
    constructor(props) {
         ...
         this.state= {
             list:[
                 {name:'الرئيسية', icon:require('../../src/Imag/Artboard11/Home.png'), active:true, link:''},
                 {name:'الشخصية', icon:require('../../src/Imag/Artboard11/Profile.png'), active:false, link:''},
                 {name:'الحجوزات', icon:require('../../src/Imag/Artboard11/Books.png'), active:false, link:''},
                 {name:'الأعدادت', icon:require('../../src/Imag/Artboard11/Settings.png'), active:false, link:''},
                 {name:'الشروط والأحكام', icon:require('../../src/Imag/Artboard11/Conditions.png'), active:false, link:''},
                 {name:'أتصل بنا', icon:require('../../src/Imag/Artboard11/Call.png'), active:false, link:''},
                 {name:'خروج', icon:require('../../src/Imag/Artboard11/Exit.png'), active:false, link:''},
             ]
         }
    }
