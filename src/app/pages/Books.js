...
import Edit from '../../Imag/Artboard12/Edit.png';
import Delete from '../../Imag/Artboard12/Delete.png';
    ...
    render () {
         return (
            <ImageBackground source={BG}  style={styles.pageBG}>
                {/* HEADER */}
                <Header title={localization.myBooks} backScreen="Home" drawer={true}/>
                <View style={{justifyContent:'center', alignItems:'center'}}>
                    <View style={{marginVertical:hp('2%'), borderColor:'#7E7560', borderWidth:wp('0.2%'), width:wp('84%'), height:hp('5%'), flexDirection:'row'}}>                   
                        <TouchableOpacity disabled={true}>
                            <Text style={{width:wp('42%'), height:hp('4.9%'), backgroundColor:'rgba(152, 145, 128, 0.7)', textAlignVertical:'center', textAlign:'center', fontSize:wp('4%'), fontWeight:'500', color:'white'}}> {localization.currentBooks} </Text>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Text style={{width:wp('42%'), height:hp('4.9%'), backgroundColor:'rgba(255, 255, 255, 0.7)', textAlignVertical:'center', textAlign:'center', fontSize:wp('4%'), fontWeight:'500', color:'#989180'}}> {localization.previousBooks} </Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{justifyContent:'center', alignItems:'center'}}>
                    ...
                    renderItem={({item}) =>{
                        return (
                        <View style={{borderRadius:wp('2%'), borderColor:'#7E7560', borderWidth:wp('0.2%'), height:'auto', width:wp('84%'), margin:hp('1%')}}>
