...
import Photo from '../../Imag/Artboard10/Photo.png';
import Video from '../../Imag/Artboard10/Video.png';
import Send from '../../Imag/Artboard10/Send.png';
import Picture from '../../Imag/Artboard10/Picture.png';
...
class Artboard10 extends Component{
    ...
    constructor(props) {
        ...
        this.state = {
            data: [
                {id:'1', date:"9:50 am", type:'in',  message: "السلام عليكم ورحمة الله وبركاتة", avatar:require('../../Imag/Artboard10/Avatar.png')},
                {id:'2', date:"9:50 am", type:'out', message: "وعليكم السلام ورحمة الله وبركاتة", avatar:require('../../Imag/Artboard10/Avatar.png')} ,
                {id:'3', date:"9:50 am", type:'in',  message: "كنت عاوز اسأل عن شئ", avatar:require('../../Imag/Artboard10/Avatar.png')}, 
                {id:'4', date:"9:50 am", type:'out',  message: "بالطبع اتفضل أخي", avatar:require('../../Imag/Artboard10/Avatar.png')}, 
                {id:'5', date:"9:50 am", type:'in', message: "شكرا لحضرتك كنت عاوز اعرف بس نظام الرحلات والفلوس والفنادق الي هنقيم فيها عاملة ازاي؟", avatar:require('../../Imag/Artboard10/Avatar.png')}, 
                {id:'6', date:"9:50 am", type:'out', message: "التفاصيل كذا كذا كذا", avatar:require('../../Imag/Artboard10/Avatar.png')}, 
                {id:'7', date:"9:50 am", type:'in',  message: "تمام شكرا لحضرتك جدا", avatar:require('../../Imag/Artboard10/Avatar.png')}, 
                {id:'8', date:"9:50 am", type:'in',  message: "العفو في الخدمه يفندم", avatar:require('../../Imag/Artboard10/Avatar.png')},
            ]
        };
    }
